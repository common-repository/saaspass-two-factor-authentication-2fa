...
?>
    ...
    <div style="border: 1px solid #eee; padding: 1em; font-size: x-small">
        ...
        <pre style="padding: 1em; font-family: monospace;"><?php if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
...
?>
    ...
    <form action="<?php echo htmlspecialchars($this->data['errorReportAddress']); ?>" method="post">
        ...
        <p>
            <textarea class="metadatabox" name="text" rows="6" cols="50" style="width: 100%; padding: 0.5em;"><?php if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
